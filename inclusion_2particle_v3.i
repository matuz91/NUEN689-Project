...
[ICs]
  ...
  # vacancy is the solute here.
    type = SpecifiedSmoothCircleIC
    # tthis needs to be the same as IC_c
    variable = etab
    x_positions = '50 83'
    y_positions = '64 64'
    z_positions = '0 0'
  ...
  [../]
  [./IC_c]
    # this needs to be done completely separately
    # because the langevin noise was overconstraining
    type = SpecifiedSmoothCircleIC
    variable = c
    x_positions = '50 83'
    y_positions = '64 64'
...
[Outputs]
  ...
  csv = true
  #interval = 1
  file_base = 'irrad_2part_v3_src_${Body_Force}'
[]
